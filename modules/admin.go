...
func loadAdminModule() {
	handlers := []*Handler{
		...
		{Command: "dmute", Func: DmuteUser, Description: "Mute and delete the replied message", ModuleName: "Admin"},
		{Command: "demote", Func: DemoteUser, Description: "Demote a user from admin", ModuleName: "Admin"},
		{Command: "dkick", Func: DkickUser, Description: "Kick and delete the replied message", ModuleName: "Admin"},
		{Command: "dban", Func: DbanUser, Description: "Ban and delete the replied message", ModuleName: "Admin"},
		{Command: "promote", Func: PromoteUser, Description: "Promote a user to admin", ModuleName: "Admin"},
		{Command: "fullpromote", Func: FullPromoteUser, Description: "Full promote a user to super admin", ModuleName: "Admin"},
		{Command: "pin", Func: PinMessage, Description: "Pin a message in the chat", ModuleName: "Admin"},
		{Command: "unpin", Func: UnpinMessage, Description: "Unpin a message in the chat", ModuleName: "Admin"},
		{Command: "zombies", Func: zombiesCmd, Description: "Find and clean deleted accounts", ModuleName: "Admin"},
		{Command: "purge", Func: PurgeCmd, Description: "Purge messages from replied to here", ModuleName: "Admin"},
		{Command: "del", Func: DeleteCmd, Description: "Delete the replied message", ModuleName: "Admin"},
		{Command: "purgefrom", Func: PurgeFromCmd, Description: "Set the start point for purge", ModuleName: "Admin"},
		{Command: "purgeto", Func: PurgeToCmd, Description: "Purge from purgefrom to here", ModuleName: "Admin"},
	}
